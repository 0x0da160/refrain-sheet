...
[`.github/workflows/code-stats.yml`](.github/workflows/code-stats.yml) on every
push to `main`; when the numbers change, that workflow opens or updates a pull
...
| ---------- | ------: | --------: | ---------: | ---------: |
| TypeScript |     244 |     5,099 |     11,264 |     55,526 |
| JSON       |       6 |         0 |          0 |      7,060 |
| Markdown   |      17 |     1,120 |          4 |      6,253 |
| CSS        |       2 |       502 |        480 |      3,407 |
| YAML       |      16 |       279 |        801 |      2,758 |
| JavaScript |      18 |       304 |        625 |      2,352 |
| HTML       |       4 |        21 |         21 |      1,262 |
| Rust       |       4 |       112 |        180 |        883 |
| Dockerfile |       1 |         8 |         21 |         21 |
| TOML       |       1 |         4 |         19 |         20 |
| SVG        |       3 |         0 |          0 |         18 |
| **Total**  | **316** | **7,449** | **13,415** | **79,560** |
...
- **Code statistics** (`.github/workflows/code-stats.yml`) runs on pushes to
  `main` and on demand: it recounts the repository with `cloc` and, only when
  the numbers actually change, opens or updates a single `chore/code-stats`
  pull request carrying the refreshed table in `README.md` (see "Code
  statistics" above). It never commits to `main`.
