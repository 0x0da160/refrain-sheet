...
/* Fluid type: [name, min rem, preferred, max rem, line-height, weight, role].
   Values are the landing site's tuned scale (site/styles.css), renamed by
   role. Minimum sizes respect foundations --text-min (12px). */
export const typeScale = [
  ['caption', 0.75, '0.7rem + 0.25vw', 0.875, 1.6, 400, 'Captions, footnotes, eyebrows'],
  ['small', 0.875, '0.8rem + 0.35vw', 1, 1.7, 400, 'Secondary copy, nav, buttons'],
  ['body', 1, '0.95rem + 0.25vw', 1.125, 1.75, 400, 'Body copy'],
  ['lead', 1.125, '1rem + 0.75vw', 1.5, 1.7, 400, 'Lead paragraphs, h3'],
  ['h2', 1.5, '1.2rem + 1.25vw', 2.25, 1.3, 700, 'Section headings'],
  ['display', 2, '1.2rem + 2.5vw', 3.25, 1.25, 700, 'Hero heading, one per page'],
];
...
export const controls = [
  ['brand-btn-h', 2.75, '44px — default button'],
...
// Brand-specific pairs, checked in light and dark (dark = night bands).
export const contrastPairs = [
  ['accent-text', 'bg-surface', 4.5, 'Eyebrow / accent text on a card'],
  ['fg-muted', 'bg-surface', 4.5, 'Card body copy'],
  ['fg-default', 'accent-subtle', 4.5, 'Text on a mist badge'],
];
