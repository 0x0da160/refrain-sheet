...
- `src/landing/main.js`, `src/landing/consent.js` are explicit entries:
  `src/landing/template.html` loads them with plain `<script src="…">`
  tags, which Knip cannot follow. `src/landing/i18n.js` needs no entry — it
