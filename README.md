...
`vendor` (only files git tracks are counted). The table between the two
markers below is regenerated by
[`scripts/code-stats.mjs`](scripts/code-stats.mjs) as part of every release
commit (`npm run release`, including the Manual release recovery workflow),
and can be refreshed by hand with the
[Release docs](.github/workflows/release-docs.yml) workflow, which opens a pull
request. Nothing outside the markers is ever machine-written.

<!-- code-stats:start -->

<!-- Generated by scripts/code-stats.mjs — do not edit by hand. -->

| Language     |   Files |      Blank |    Comment |        Code |
| ------------ | ------: | ---------: | ---------: | ----------: |
| TypeScript   |     320 |      6,378 |     13,559 |      67,369 |
| JSON         |      22 |          0 |          0 |      11,825 |
| Markdown     |      86 |      2,011 |          4 |      10,850 |
| CSS          |      50 |      1,004 |      1,501 |      10,518 |
| JavaScript   |      33 |        434 |      1,174 |       4,718 |
| HTML         |      20 |        129 |         56 |       3,612 |
| YAML         |      14 |        200 |        433 |       1,305 |
| Rust         |       4 |        112 |        180 |         883 |
| SVG          |      11 |          0 |         52 |          98 |
| Bourne Shell |       1 |         11 |         19 |          47 |
| Dockerfile   |       1 |          8 |         26 |          40 |
| TOML         |       2 |          4 |         26 |          24 |
| **Total**    | **564** | **10,291** | **17,030** | **111,289** |
