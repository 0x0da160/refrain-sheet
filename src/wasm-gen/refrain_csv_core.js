...
/* @ts-self-types="./refrain_csv_core.d.ts" */
...
if (Symbol.dispose) ParseIndex.prototype[Symbol.dispose] = ParseIndex.prototype.free;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./refrain_csv_core_bg.js": import0,
    };
}

const ParseIndexFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_parseindex_free(ptr, 1));
