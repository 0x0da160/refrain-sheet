...
import { cellLabel, columnLabel, isFormula, parseRef, shiftFormulaRefs } from '../core/formula';
...
import { LARGE_OP_CELLS, pct, withBusy } from './commands/shared';
...
export class Commands {
  ...
  private async withBusy<T>(label: string, work: () => T | Promise<T>): Promise<T> {
    return withBusy(this.ui, label, work);
  }
