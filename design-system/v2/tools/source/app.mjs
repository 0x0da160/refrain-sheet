...
export const canvas = {
  ...
  'canvas-find-current': ['amber.600', 'amber.300', 'Find: outline of the current match'],
  ...
  'ref-3': ['amber.600', 'amber.300', 'Formula reference 3 (dotted border)'],
  ...
  'ref-3-fill': [{ ref: 'amber.600', alpha: 0.12 }, { ref: 'amber.300', alpha: 0.16 }, ''],
...
// Coarse pointer: every step grows by the same amount (+2px text, +4px
// line), so the hierarchy survives arm's-length reading and fields reach
...
// Inline padding does not follow density: [name, px, description].
export const inline = [
...
export const layers = [
  ...
  ['z-modal', 200, 'Modal dialog and its scrim; the file-drop target'],
  ['z-overlay', 250, 'Blocking overlays: loading (above a file drop)'],
  ['z-toast', 300, 'Toasts'],
